...
const EMPTY = {
  sl:'', customer_name:'', name:'', private_ip:'', business_app:'', hostname:'',
  os_name:'', os_version:'', server_type:'', environment:'', platform:'',
  ops_manager:'', azure_update_schedule:'', onboarded_defender:'', onboarded_pam:'',
  ipa_integration:'', msb_compliance:'', subscription:'', location:'', resource_group:'',
  owner:'', owner_team:'', criticality:'', support_suma:'', support_dcentral:'',
  dcentral:'', crowdstrike:'', status:'Active', notes:'', custom_data:{}
}
      ...
      <div className="modal">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-row-3">
            ...
            <F label="Customer Name"><input value={form.customer_name} onChange={e => set('customer_name', e.target.value)} placeholder="Acme Corp" /></F>
          ...
          <div className="form-row" style={{ marginTop:12 }}>
            <F label="Name"><input value={form.name} onChange={e => set('name', e.target.value)} placeholder="Display name" /></F>
          ...
          <div className="form-row" style={{ marginTop:12 }}>
            <F label="OpsManager"><input value={form.ops_manager} onChange={e => set('ops_manager', e.target.value)} /></F>
            <F label="Azure UpdateManager Schedule"><input value={form.azure_update_schedule} onChange={e => set('azure_update_schedule', e.target.value)} /></F>
          </div>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:12 }}>
            ...
            <F label="IPA Integration"><input value={form.ipa_integration} onChange={e => set('ipa_integration', e.target.value)} /></F>
            <F label="MSB Compliance"><input value={form.msb_compliance} onChange={e => set('msb_compliance', e.target.value)} /></F>
            ...
            <F label="DCentral"><input value={form.dcentral} onChange={e => set('dcentral', e.target.value)} /></F>
          </div>
